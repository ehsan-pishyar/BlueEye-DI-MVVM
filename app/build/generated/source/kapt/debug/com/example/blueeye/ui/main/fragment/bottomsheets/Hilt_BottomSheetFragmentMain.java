...
public abstract class Hilt_BottomSheetFragmentMain extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BottomSheetFragmentMain_GeneratedInjector) this.generatedComponent()).injectBottomSheetFragmentMain(UnsafeCasts.<BottomSheetFragmentMain>unsafeCast(this));
    }
  }
