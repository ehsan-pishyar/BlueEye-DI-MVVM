...
import com.example.blueeye.data.di.WeatherModule_ProvideBaseUrlFactory;
import com.example.blueeye.data.di.WeatherModule_ProvideRetrofitFactory;
import com.example.blueeye.data.di.WeatherModule_ProvideWeatherApiServiceFactory;
import com.example.blueeye.data.di.WeatherModule_ProvideWeatherServiceFactory;
import com.example.blueeye.data.repository.WeatherRepository;
import com.example.blueeye.ui.main.MainActivity;
import com.example.blueeye.ui.main.fragment.MainFragment;
import com.example.blueeye.ui.main.fragment.SearchFragment;
import com.example.blueeye.ui.main.fragment.bottomsheets.BottomSheetFragmentMain;
import com.example.blueeye.ui.viewmodel.WeatherViewModel;
import com.example.blueeye.ui.viewmodel.WeatherViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC extends BaseApplication_HiltComponents.SingletonC {
  ...
  private volatile Object weatherService = new MemoizedSentinel();

  private volatile Object weatherServiceHelper = new MemoizedSentinel();
  ...
  private String string() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = string;
        if (local instanceof MemoizedSentinel) {
          local = WeatherModule_ProvideBaseUrlFactory.provideBaseUrl();
  ...
  private Retrofit retrofit() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = retrofit;
        if (local instanceof MemoizedSentinel) {
          local = WeatherModule_ProvideRetrofitFactory.provideRetrofit(string());
  ...
  private WeatherService weatherService() {
    Object local = weatherService;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = weatherService;
        if (local instanceof MemoizedSentinel) {
          local = WeatherModule_ProvideWeatherServiceFactory.provideWeatherService(retrofit());
          weatherService = DoubleCheck.reentrantCheck(weatherService, local);
        }
      }
    }
    return (WeatherService) local;
  }

  private WeatherServiceHelperImpl weatherServiceHelperImpl() {
    return new WeatherServiceHelperImpl(weatherService());
  }

  private WeatherServiceHelper weatherServiceHelper() {
    Object local = weatherServiceHelper;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = weatherServiceHelper;
        if (local instanceof MemoizedSentinel) {
          local = WeatherModule_ProvideWeatherApiServiceFactory.provideWeatherApiService(weatherServiceHelperImpl());
          weatherServiceHelper = DoubleCheck.reentrantCheck(weatherServiceHelper, local);
        }
      }
    }
    return (WeatherServiceHelper) local;
  }
  ...
  private static final class ActivityRetainedCImpl extends BaseApplication_HiltComponents.ActivityRetainedC {
    ...
    private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
      ...
      private static final class FragmentCI extends BaseApplication_HiltComponents.FragmentC {
        ...
        @Override
        public void injectBottomSheetFragmentMain(BottomSheetFragmentMain arg0) {
        }
    ...
    private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
      ...
      private WeatherRepository weatherRepository() {
        return new WeatherRepository(singletonC.weatherServiceHelper());
      }
      ...
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return Collections.<String, Provider<ViewModel>>singletonMap("com.example.blueeye.ui.viewmodel.WeatherViewModel", (Provider) weatherViewModelProvider());
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.example.blueeye.ui.viewmodel.WeatherViewModel 
